            ...
            <nav class="bg-white border-b border-gray-100">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <div class="ml-3 relative flex items-center" :class="['border-b-1', {'border-b-2 border-primary-400': isReportsRoute }]">
                                    <Dropdown width="48">
                                        ...
                                        <template #content>
                                            <DropdownLink :href="route('reports.best-customers')">
                                                Best Customers
                                            </DropdownLink>
                                            <DropdownLink :href="route('reports.best-sellers')">
                                                Best Sellers
                                            </DropdownLink>
                                            <DropdownLink :href="route('reports.order-status')">
                                                Order Status
                                            </DropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <ResponsiveNavLink :href="route('reports.best-customers')">
                            Best Customers Report
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('reports.best-sellers')">
                            Best Sellers Report
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('reports.order-status')">
                            Order Status Report
                        </ResponsiveNavLink>
                    </div>
